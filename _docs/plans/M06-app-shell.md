...
- [ ] Settings drawer (Vaul, 480px from right):
    ...
    - **Appearance
      ** category is fully real here: theme picker (uses M02 toggle for now, expanded to swatches in M20), mode segmented control, density segmented control, animation level
