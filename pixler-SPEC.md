...
|Styling                 |Tailwind v4 + CSS variables + `@pixler/tokens`    |Runtime theme switching with no rebuild                                                                                                             |
...
|**`@pixler/tokens`**    |Shared design token package (themes, spacing, typography).                                           |
