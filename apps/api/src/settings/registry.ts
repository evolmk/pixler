...
export const settingsRegistry: SettingDefinition[] = [
  ...
  { key: 'models.planner', type: 'string', default: 'claude:opus', scopes: ['global', 'project'], label: 'Planner', description: 'Default model family for planning (provider:family, e.g. claude:opus)' },
  { key: 'models.reviewer', type: 'string', default: 'claude:opus', scopes: ['global', 'project'], label: 'Reviewer', description: 'Default model family for review (provider:family, e.g. claude:opus)' },
  { key: 'models.executor', type: 'string', default: 'claude:sonnet', scopes: ['global', 'project'], label: 'Executor', description: 'Default model family for execution (provider:family, e.g. claude:sonnet)' },
